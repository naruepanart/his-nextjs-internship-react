        ...
        <CardBody>
              ...
              <CardBody>
                <Row>
                  <Col md="2">
                    ...
                    <Input type="select" name="select" required bsSize="sm">
                  ...
                  <Col md="3">
                    <Label>ชื่อ</Label>
                    <Input name="Forename" type="text" bsSize="sm" required />
                  </Col>
                  <Col md="3">
                    <Label>นามสกุล</Label>
                    <Input type="text" name="Nickname" bsSize="sm" required />
                  </Col>
                  <Col md="2">
                    <Label>ชื่อกลาง</Label>
                    <Input type="text" name="Middlename" bsSize="sm" />
                  </Col>
                  <Col md="2">
                    <Label>ชื่อเล่น</Label>
                    <Input type="text" name="Nickname" bsSize="sm" />
                  </Col>
                </Row>
              </CardBody>
            </Card>
                ...
                <Row>
                  ...
                  <Col md="2">
                    <FormGroup>
                      ...
                      <Input type="text" name="MiddlenameEN" bsSize="sm" />
                    </FormGroup>
                  </Col>
                  <Col md="2">
                    <FormGroup>
                      <Label>Nickname</Label>
                      <Input type="text" name="NicknameEN" bsSize="sm" />
                    </FormGroup>
                  </Col>
                </Row>
              </CardBody>
            ...
            <CardBody>
              <Row>
                ...
                <Col md="3">
                  <FormGroup>
                    ...
                    <Input type="date" name="NIDStartDttm" bsSize="sm" />
                  </FormGroup>
                </Col>
                <Col md="3">
                  <FormGroup>
                    <Label>วันที่สิ้นสุด</Label>
                    <Input type="date" name="NIDEndDttm" bsSize="sm" />
                  </FormGroup>
                </Col>
                <Col md="2">
                  <br />
              ...
              <Row>
                <Col md="3">
                  <FormGroup>
                    ...
                    <Input type="date" name="Birthdate" bsSize="sm" required />
                  </FormGroup>
                </Col>
                <Col md="2">
                  <FormGroup>
                ...
                <Col md="4">
                  ...
                  <Input type="select" name="select" bsSize="sm" required>
                    <option>select..</option>
                    <option>1</option>
                    <option>2</option>
                    <option>3</option>
              ...
              <Row>
                <Col md="2">
                  <FormGroup>
                    ...
                    <Input type="number" name="PhoneNumber" bsSize="sm" />
                  </FormGroup>
                </Col>
                <Col md="2">
                  <FormGroup>
                    <Label>เบอร์โทร 2</Label>
                    <Input type="number" name="PhoneNumber2" bsSize="sm" />
                  </FormGroup>
                </Col>
                <Col md="2">
                  <FormGroup>
                    <Label>เบอร์โทร 2</Label>
                    <Input type="number" name="PhoneNumber3" bsSize="sm" />
                  </FormGroup>
                </Col>
                <Col md="2">
                  <FormGroup>
                    <Label>เบอร์บ้าน</Label>
                    <Input type="number" name="HomePhone" bsSize="sm" />
                  </FormGroup>
                </Col>
                <Col md="2">
                  <FormGroup>
                    <Label>เบอร์ที่ทำงาน</Label>
                    <Input type="number" name="WorkPhone" bsSize="sm" />
                  </FormGroup>
                </Col>
              </Row>
              ...
              <Row>
                <Col md="6">
                  <FormGroup>
                    <Label> E-mail</Label>
                    <Input type="email" name="Email" bsSize="sm" />
                  </FormGroup>
                </Col>
                <Col md="6">
                  <FormGroup>
                    <Label>ID Line</Label>
                    <Input type="text" name="Line" bsSize="sm" />
                  </FormGroup>
                </Col>
              </Row>
            </CardBody>
          ...
          <Card>
            <CardBody>
              <Row>
                ...
                <FormGroup check inline>
                  <Label>
                    <Input type="text" disabled bsSize="sm" />
                  </Label>
                </FormGroup>
                <FormGroup check inline>
                  <Label check>
          ...
          <Card>
            ...
            <CardBody>
              <Row>
                <Col md="4">
                  <Label for="exampleSelect">ประเภทบัตร</Label>
                  <Input type="select" name="select" bsSize="sm">
                    <option>select..</option>
                    <option>1</option>
                    <option>2</option>
                ...
                <Col md="4">
                  <FormGroup>
                    ...
                    <Input type="text" name="cardid" bsSize="sm" />
                  </FormGroup>
                </Col>
              </Row>
              ...
              <Row>
                <Col md="4">
                  <FormGroup>
                    <Label> วันที่เริ่ม</Label>
                    <Input type="date" name="cardstart" bsSize="sm" />
                  </FormGroup>
                </Col>
                <Col md="4">
                  <FormGroup>
                    <Label>วันที่สิ้นสุด</Label>
                    <Input type="date" name="cardexpire" bsSize="sm" />
                  </FormGroup>
                </Col>
              </Row>
              <Row>
